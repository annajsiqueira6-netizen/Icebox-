<?php
// ============================================================
// MIGRAÇÃO - Cria a estrutura do banco e o usuário administrador
// Rode este arquivo pelo navegador UMA VEZ (ex: http://localhost/sistema-teste/migrate.php)
// Pode rodar mais de uma vez sem problema: usa IF NOT EXISTS e checa duplicidade.
// 100% procedural (mysqli_*)
// ============================================================
...
$sql = "
    CREATE TABLE IF NOT EXISTS usuarios (
        ...
        tipo_usuario    ENUM('administrador', 'comissao', 'jogador') NOT NULL DEFAULT 'jogador',
...
// ---------- Cria a conta administrador (só se ainda não existir) ----------
$emailAdmin = 'admin@moneyball.com';
$senhaAdmin = 'admin123'; // troque depois de testar!
...
if ($total == 0) {
    $senhaHash = password_hash($senhaAdmin, PASSWORD_DEFAULT); // RNF01
    $nome = 'Administrador';
    $tipo = 'administrador';
