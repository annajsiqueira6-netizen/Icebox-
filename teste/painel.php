...
<div class="hero">
    <div>
        <div class="eyebrow-title"><span class="dash"></span><span>Painel geral</span></div>
        <h1>Bem-vindo(a), <?php echo htmlspecialchars($_SESSION['nome']); ?></h1>
        <p style="max-width:520px; margin-top:6px;">
    ...
    <div class="hero-radar"><div class="hero-radar-dot"></div></div>
</div>

<div class="stat-grid">
    <div class="stat-card">
        <div class="eyebrow"><svg viewBox="0 0 24 24"><path d="M4 19V10M10 19V5M16 19v-7M22 19H2"/></svg>Jogadores cadastrados</div>
        <div class="value" data-count="<?php echo $totalJogadores; ?>">0</div>
        <div class="sub">Elenco ativo no sistema</div>
    </div>
    <div class="stat-card">
        <div class="eyebrow"><svg viewBox="0 0 24 24"><path d="M13 2 3 14h7l-1 8 10-12h-7l1-8Z"/></svg>Partidas registradas</div>
        <div class="value" data-count="<?php echo $totalPartidas; ?>">0</div>
        <div class="sub">Estatísticas lançadas</div>
    </div>
    <div class="stat-card">
        <div class="eyebrow"><svg viewBox="0 0 24 24"><circle cx="12" cy="8" r="4"/><path d="M4 20c0-3.6 3.4-6 8-6s8 2.4 8 6"/></svg>Agente mais usado</div>
    ...
    <div class="stat-card">
        <div class="eyebrow"><svg viewBox="0 0 24 24"><circle cx="9" cy="8" r="3.2"/><path d="M3.5 19c0-3.3 2.5-5.5 5.5-5.5s5.5 2.2 5.5 5.5"/><path d="M15.2 5.2a2.9 2.9 0 1 1 2.1 5"/><path d="M15 13.7c2.6.3 4.5 2.3 4.5 5.3"/></svg>Usuários do sistema</div>
        <div class="value" data-count="<?php echo $totalUsuarios; ?>">0</div>
